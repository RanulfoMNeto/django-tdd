...
class AnimaisTestCase(LiveServerTestCase):
    ...
    def setUp(self):
        self.browser = webdriver.Chrome('/Users/ranulfomascarineto/Documents/Projetos/Alura/Formação Django/tdd_busca_animal/chromedriver')
    ...
    def test_buscando_um_novo_animal(self):
        ...
        # Ele encontra o Busca Aniaml e decide usar o site,
        home_page = self.browser.get(self.live_server_url + '/')
        # porque ele vê o menu do site escrito Busca Animal,
